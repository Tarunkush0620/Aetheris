...
const BODIES = {
  ...
  // ── Train: simple rectangle with a pointed nose, reads clearly as a ground vehicle
  train: `
    <path d="M-6,-30 L0,-35 L6,-30 L6,35 L-6,35 Z" fill="white" ${STROKE}/>
    <rect x="-4" y="-25" width="8" height="50" rx="1" fill="rgba(0,0,0,0.2)"/>`,

  // ── Bus: rectangular with rounded corners, shorter and wider than train
  bus: `
    <rect x="-8" y="-20" width="16" height="40" rx="4" fill="white" ${STROKE}/>
    <rect x="-6" y="-18" width="12" height="6" rx="1" fill="rgba(0,0,0,0.3)"/>
    <rect x="-6" y="-8" width="12" height="24" rx="1" fill="rgba(0,0,0,0.15)"/>`,
